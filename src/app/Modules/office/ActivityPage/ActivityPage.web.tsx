// app/Admin/OfficeInventory/ActivityPage/ActivityPage.web.tsx
...
// ─── CSV export (web-only: Blob + <a download>) ────────────────────────────

function exportCsv(rows: StockTransaction[], unitMap: Record<string, string>) {
  const csv = buildActivityCsv(rows, unitMap);
...
// ─── Mobile (small-viewport) activity card ─────────────────────────────────
// NOTE: this is the web page's responsive card for narrow browser widths —
// distinct from ActivityPage.native.tsx, which is the actual React Native
// app screen.
      ...
      <div className="flex-shrink-0 px-4 pt-4 pb-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Export button */}
            <button
              onClick={() => exportCsv(filtered, unitMap)}
